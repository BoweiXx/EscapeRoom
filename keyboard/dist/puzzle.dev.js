...
var correctAnswer = ['e', 'e', 's', 's', 'c', 'c', 'a', 'a', 'p', 'p', 'e', 'e']; //ESCAPE compromised 

var maxi = 12; //max input times = 6 or can just retrieve from reading len of crtasr
...
function draw() {
  ...
  console.log(indexi); // background(220);
